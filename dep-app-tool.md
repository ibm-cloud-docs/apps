...
* Install the [{{site.data.keyword.cloud_notm}} Command Line Interface (CLI)](/docs/cli?topic=cli-getting-started), which includes the {{dev_cli_short}} [(`ibmcloud dev`)](/docs/cli?topic=cli-idt-cli) commands.
