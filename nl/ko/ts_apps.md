...
Node.js 앱에 대한 추가 팁은 [Tips for Node.js Applications](https://docs.cloudfoundry.org/buildpacks/node/node-tips.html ![External link icon](../icons/launch-glyph.svg "외부 링크 아이콘"){: new_window}를 참조하십시오.
