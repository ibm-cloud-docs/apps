...
{{site.data.keyword.cloud_notm}}에서는 iOS Swift 및 Android용의 몇 가지 모바일 스타터 킷을 제공합니다. 모바일 패턴의 스타터 킷은 [{{site.data.keyword.cloud_notm}} 모바일 개발자 콘솔](https://{DomainName}/developer/mobile/dashboard){: new_window} ![외부 링크 아이콘](../icons/launch-glyph.svg "외부 링크 아이콘")에서 찾을 수 있습니다.
