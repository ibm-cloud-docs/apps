...
* [{{site.data.keyword.dev_cli_short}}](/docs/cli/index.html#overview)을 설치하십시오.
...
4. 선택사항. 앱을 분류하기 위한 태그를 제공하십시오. 자세한 정보는 [태그에 대한 작업](/docs/resources/tagging_resources.html)을 참조하십시오.
