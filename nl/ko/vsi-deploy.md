...
이러한 환경 특성을 보려면 다음 단계를 따르십시오. 사용 가능한 특성에 대해 알아보려면 표를 참조하십시오.
...
Terraform에서 인프라 리소스를 작성하려면 인프라 API 키가 필요합니다. 인프라 API 키는 배치 중에 자동으로 확보됩니다. 수동으로 키를 검색하려면 다음 단계를 따르십시오.
...
인프라 사용자 이름도 배치 중에 자동으로 확보되어 사용됩니다. 수동으로 키를 검색하려면 다음 단계를 따르십시오.
...
Terraform에서 데이터베이스 및 Compose 서비스와 같은 플랫폼 레벨 서비스를 작성하기 위해 플랫폼 API 키가 자동으로 확보되어 파이프라인에 환경 변수로 저장됩니다. 수동으로 플랫폼 키를 검색하려면 다음 단계를 따르십시오.
