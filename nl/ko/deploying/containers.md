...
서비스에 대해 자세히 알아보려면 [{{site.data.keyword.containershort_notm}} 시작하기](/docs/containers?topic=containers-getting-started)를 참조하십시오.
...
자세한 정보는 [IBM Cloud Container 레지스트리 시작하기](/docs/services/Registry?topic=registry-getting-started)를 참조하십시오.
