...
{{site.data.keyword.openwhisk_short}} 사용자 인터페이스(UI) 또는 명령행 인터페이스(CLI)를 사용하여 애플리케이션을 개발할 수 있습니다. 둘 모두 애플리케이션 개발을 위한 유사한 기능이 있습니다. CLI는 배치 및 오퍼레이션에 대한 추가 제어를 제공합니다. {{site.data.keyword.openwhisk_short}}에 대한 자세한 정보는 전체 [Openwhisk 문서](/docs/openwhisk/index.html)를 참조하십시오. 
