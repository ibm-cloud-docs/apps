...
1. Em seu painel do [{{site.data.keyword.cloud_notm}} ![Ícone de link externo](../../icons/launch-glyph.svg "Ícone de link externo")](https://cloud.ibm.com), clique em **Criar um app** no widget Apps.
...
3. Insira um nome de host exclusivo, por exemplo, `abc-devhost`. O nome do host é usado para a rota de seu app, por exemplo, `abc-devhost.cloud.ibm.com`
4. É possível, opcionalmente, fornecer identificações para classificar o seu app. Para obter mais informações, consulte [Trabalhando com tags](/docs/resources/tagging_resources.html#tag).
5. Selecione a linguagem e a estrutura. Alguns kits do iniciador podem estar disponíveis apenas em uma linguagem.
6. Selecione seu plano de precificação. É possível usar a opção grátis para esse tutorial.
7. Clique em **Criar**.

## Incluindo recursos (opcional)
{: #resources-scratch}

É possível incluir recursos que aprimoram seu app com o poder cognitivo do Watson, incluir serviços móveis ou serviços de segurança. Para este tutorial, é possível incluir um local para gerenciar os seus dados.
...
adicionais, consulte:
* [Construindo e implementando](/docs/services/ContinuousDelivery/pipeline_build_deploy.html#deliverypipeline_build_deploy) com Entrega contínua.
* [Criando cadeias de ferramentas](/docs/services/ContinuousDelivery/toolchains_working.html#toolchains_getting_started) por meio de um modelo.
