...
É possível criar um projeto de um iniciador de backend para frontend. Use esses iniciadores para construir APIs de backend para frontend no Node.js, Java ou Swift usando uma variedade de estruturas: Express.js, MicroProfile/Java EE, Kitura ou Spring. É possível ver como instalar as ferramentas necessárias, construir e executar o projeto localmente e implementá-lo na nuvem.
{: shortdesc}
...
2. Insira o nome do projeto. Para este tutorial, use `ExpressBackend`.
