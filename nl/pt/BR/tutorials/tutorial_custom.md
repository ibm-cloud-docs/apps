...
É possível criar um aplicativo customizado usando os serviços e um tempo de execução. É possível ver como instalar as ferramentas necessárias, criar e executar o app localmente e implantá-lo na nuvem.
{: shortdesc}
