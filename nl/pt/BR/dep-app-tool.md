...
Antes de começar, use o [painel do {{site.data.keyword.cloud_notm}}](https://{DomainName}){: new_window} ![Ícone de link externo](../icons/launch-glyph.svg "Ícone de link externo") para [criar o seu aplicativo](/docs/apps?topic=creating-apps-getting-started) e [incluir serviços](/docs/apps?topic=creating-apps-getting-started#resources-getting-started).
