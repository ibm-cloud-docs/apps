...
{{site.data.keyword.cloud_notm}} ha portali per gli sviluppatori in diverse aree di interesse (come Watson) o un canale digitale (come Mobile o Applicazioni Web). Puoi accedere a questi portali dall'icona **Menu** ![Icona Menu](../../icons/icon_hamburger.svg).
...
Se un kit starter richiede servizi specifici, vengono automaticamente create e connesse alla tua applicazione delle istanze del servizio di cui viene eseguito il provisioning automaticamente.
