...
- Installa l'[interfaccia riga di comando (o CLI, command-line interface) {{site.data.keyword.dev_cli_notm}}](/docs/cli/index.html#overview), che include la CLI {{site.data.keyword.containershort_notm}}.
