...
Puoi trovare i kit starter per il modello dell'applicazione web nella [console dello sviluppatore {{site.data.keyword.cloud_notm}} App Service](https://{DomainName}/developer/appservice/dashboard){: new_window} ![Icona link esterno](../icons/launch-glyph.svg "Icona link esterno").

## Applicazioni del microservizio
{: #microservice}
...
{{site.data.keyword.cloud_notm}} offre diversi kit starter per dispositivo mobile per iOS Swift e Android. Puoi trovare i kit starter per i modelli del dispositivo mobile nella [console dello sviluppatore {{site.data.keyword.cloud_notm}} Mobile](https://{DomainName}/developer/mobile/dashboard){: new_window} ![Icona link esterno](../icons/launch-glyph.svg "Icona link esterno").

Inoltre, puoi creare un'applicazione mobile personalizzata utilizzando un kit starter di base e selezionando il tipo di applicazione mobile. Per ulteriori informazioni, vedi [Creazione di un'applicazione mobile](/docs/apps?topic=creating-apps-tutorial-mobile).

## Applicazioni basate sul linguaggio
{: #languages}

I kit starter forniti da {{site.data.keyword.cloud_notm}} sono disponibili in molti linguaggi e framework. Ad esempio, i kit starter del microservizio cloud offrono un'opzione Node.js, mentre i kit starter strettamente collegati all'analisi dei dati possono includere Python o Go. Vengono illustrati alcuni linguaggi comuni utilizzati nei kit starter {{site.data.keyword.cloud_notm}}.

|Linguaggio programmazione | Descrizione | Framework di sviluppo |
|-----|-----|-----|
|Java | [Java](/docs/runtimes/liberty?topic=liberty-getting-started) è ottimo per la creazione di applicazioni a livello aziendale. Le nuove funzioni in Java 8, però, combinate con runtime più leggeri come Liberty e framework come Spring Boot, rendono Java anche una scelta perfetta per la creazione dei microservizi. Java è un linguaggio di programmazione popolare per le applicazioni Android. | Spring, Liberty, Android |
...
{: caption="Tabella 1. Linguaggi utilizzati nei kit starter." caption-side="top"}
