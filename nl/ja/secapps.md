...
ます。
    ...
    {{site.data.keyword.cloud_notm}} では以下のタイプの証明書がサポートされています。
  ...
  #### 秘密鍵
    ...
    {{site.data.keyword.cloud_notm}} では以下のタイプの秘密鍵がサポートされています。
