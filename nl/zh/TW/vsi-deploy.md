...
1. [建立應用程式](apps/index.html#createapp)。 
...
任何 App Service 入門範本套件都可以透過 [Terraform ![外部鏈結圖示](../icons/launch-glyph.svg)](https://ibm-cloud.github.io/tf-ibm-docs/v0.10.0/){: new_window} 部署在動態建立的虛擬實例，Terraform 是開放程式碼基礎架構，作為程式碼架構之用。 
