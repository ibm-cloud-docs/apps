...
* Installieren Sie die [{{site.data.keyword.dev_cli_short}}](/docs/cli/index.html#overview).
...
4. Optional. Geben Sie Tags an, um Ihre App zu klassifizieren. Weitere Informationen finden Sie in [Mit Tags arbeiten](/docs/resources/tagging_resources.html).
