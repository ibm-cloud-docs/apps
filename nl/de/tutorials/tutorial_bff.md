...
Sie können eine Anwendung auf der Basis eines Back-End-for-Front-End-Starters erstellen. Verwenden Sie diese Starter, um Back-End-for-Front-End-Apps in Node.js, Java&reg oder Swift mithilfe verschiedener Frameworks zu erstellen: Express.js, MicroProfile/ Java&reg EE, Kitura oder Spring. Sie erfahren, wie die erforderlichen Tools installiert werden, wie die App lokal erstellt und ausgeführt wird und wie sie in der Cloud bereitgestellt wird.
{: shortdesc}
