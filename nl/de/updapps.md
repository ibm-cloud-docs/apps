...
`domain` ist der Name Ihrer Domäne und `hostname` ist der Hostname der Route für Ihre Anwendung. Um weitere Informationen zum Befehl **ibmcloud app route-delete** zu erhalten, geben Sie Folgendes ein: `ibmcloud app route-delete -h`.
