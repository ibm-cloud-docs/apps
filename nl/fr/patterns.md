...
|-----|-----|-----|
|Java | [Java](../runtimes/liberty/getting-started.html) est idéal pour la génération des applications destinées aux entreprises. Mais les nouvelles fonctionnalités de Java 8, associées à des temps d'exécution de poids plus réduit comme ceux assurés par Liberty et les infrastructures telles Spring Boot font de Java un outil idéal pour la génération des microservices. De plus, Java est un langage de programmation populaire pour les applications Android. | Spring, Liberty, Android |
