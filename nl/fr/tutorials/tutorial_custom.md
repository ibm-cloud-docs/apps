...
Vous pouvez créer une application personnalisée à l'aide de services et d'un environnement d'exécution. Vous verrez comment installer les outils dont vous avez besoin, vous générerez et exécuterez le projet localement et vous le déploierez sur le cloud.
{: shortdesc}
...
1. Sur la page [Kits de démarrage ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://console.ng.bluemix.net/developer/appservice/starter-kits/) de la console {{site.data.keyword.dev_console}}, sélectionnez **Créer un projet** pour créer une application personnalisée. 

2. Entrez un nom de projet. Pour ce tutoriel, utilisez `CustomProject`.   
