...
Vous pouvez créer un projet à partir d'un module de démarrage de  base de microservice. Utilisez ces modules de démarrage pour générer un système de back end de microservice pour Node, Java ou Python avec un choix de structures Web. Vous verrez comment installer les outils dont vous avez besoin, vous générerez et exécuterez le projet localement et vous le déploierez sur le cloud.
{: shortdesc}
...
2. Entrez un nom de projet. Pour ce tutoriel, utilisez `MicroserviceProject`.   
