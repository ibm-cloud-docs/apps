...
{{site.data.keyword.cloud_notm}} ofrece varios kits de inicio para apps móviles para iOS Swift, Android y Cordova. Encontrará los kits de inicio para el patrón móvil en la [Consola de desarrollador de Mobile de {{site.data.keyword.cloud_notm}}](https://{DomainName}/developer/mobile/dashboard){: new_window} ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo").
