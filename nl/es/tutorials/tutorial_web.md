...
Puede crear un proyecto a partir de un iniciador web básico. Utilice estos iniciadores para configurar un servidor web simple para Swift, Node, Java, Python con distintas infraestructuras web. Decida la forma en la que instalar las herramientas que necesita, compile y ejecute el proyecto localmente y despliéguelo en la nube.
{: shortdesc}
...
3. Modifique el código como crea conveniente.
...
5. Abra su navegador en `http://localhost:3000` (el número de puerto puede ser diferente dependiendo del tiempo de ejecución elegido).
