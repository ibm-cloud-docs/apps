...
1. En el [panel de control de {{site.data.keyword.cloud_notm}} ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://cloud.ibm.com), pulse **Crear una app** en el widget Apps.
...
3. Especifique un nombre de host exclusivo, por ejemplo, `abc-devhost`. El nombre de host se utiliza para la ruta de la app, por ejemplo `abc-devhost.cloud.ibm.com`
4. Si lo desea, puede proporcionar etiquetas para clasificar la app. Para obtener más información, consulte [Cómo trabajar con etiquetas](/docs/resources/tagging_resources.html#tag).
...
## Adición de recursos (opcional)
{: #resources-scratch}

Puede añadir recursos para mejorar la app con la potencia cognitiva de Watson, para añadir servicios móviles o servicios de seguridad. Para esta guía de aprendizaje, puede añadir un lugar para gestionar los datos.
...
* [Creación y despliegue](/docs/services/ContinuousDelivery/pipeline_build_deploy.html#deliverypipeline_build_deploy) con entrega continua.
* [Creación de cadenas de herramientas](/docs/services/ContinuousDelivery/toolchains_working.html#toolchains_getting_started) a partir de una plantilla.
