...
3. Enter a unique host name, such as your initials plus `-devhost`. For example:
	...
	This host name will be used for your project's route. For example,`abc-devhost.mybluemix.net`
